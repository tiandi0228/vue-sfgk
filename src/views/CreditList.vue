<template lang="html">
  <div class="credit-list" :style="{height:Height + 'px'}">
    <div class="tab">
      <!--<router-link class="item" :to="{path: '/creditlist/1'}" tag="span">个人未履行生效裁判信息</router-link>-->
      <!--<router-link class="item" :to="{path: '/creditlist/2'}" tag="span">单位未履行生效裁判信息</router-link>-->
      <span class="item" :class='{"selected":selectItem === 1}' @click="changeItem(1)">个人未履行生效裁判信息</span>
      <span class="item" :class='{"selected":selectItem === 2}' @click="changeItem(2)">单位未履行生效裁判信息</span>
    </div>
    <div class="search">
      <form v-on:submit.prevent="searchList">
        ...
        <mu-text-field v-model="credentialsNumber" hintText="请输入证件号码" />
